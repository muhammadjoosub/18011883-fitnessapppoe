...
public class Meals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addCal=findViewById(R.id.btn_addCalories);
        final ProgressBar caloriesMeals = (ProgressBar) findViewById(R.id.progressBarCal);
        addCal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                caloriesMeals.setProgress(Integer.parseInt(calories.getText().toString()));
